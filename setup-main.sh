...
while true; do
    ...
    echo "1. Ubah Password VPS/Change Password"
...
rm -f /usr/bin/user
username=$(curl -s https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/REGIST | grep $MYIP | awk '{print $2}')
if [ -z "$username" ]; then
...
valid=$(curl -s https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/REGIST | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl -s https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
function first_setup() {
    ...
    echo "========== INSTALASI PERTAMA SELESAI =========="
}
...
EOF
    ...
    # Perbaiki URL dengan menambahkan https://
    wget -q -O /usr/local/kyt/udp-mini "https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/files/udp-mini"
    ...
    for i in {1..3}; do
        # Perbaiki URL dengan menambahkan https://
        wget -q -O /etc/systemd/system/udp-mini-${i}.service "https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/files/udp-mini-${i}.service"
    done
...
TIMES=30
    ...
    local USRSC=$(wget -qO- https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/REGIST | grep "$ipsaya" | awk '{print $2}' | head -n 1)
    local EXPSC=$(wget -qO- https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/REGIST | grep "$ipsaya" | awk '{print $3}' | head -n 1)
    ...
    local TEXT="<b>✅ INSTALASI VPN SELESAI ✅</b>
...
function install_openvpn() {
    ...
    # Perbaiki URL dengan menambahkan https://
    if wget https://raw.githubusercontent.com/Dikajuana/wilda/refs/heads/will/files/openvpn -O /root/openvpn_setup.sh; then
